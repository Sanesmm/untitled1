...
public class Main  {
    ...
    static String input = "";  //deklarera variabel string
    ...
    public static void main(String[] args) {
        ...
        input = r.scan.next();     //sparar våra input
        r.programIsRunning(input);
        ...
        System.out.println("Antal ord: " + logic.getAntalRader(input.length()));
